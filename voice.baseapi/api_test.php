   ...
   private function base_tv_registration()
    {
		...
		//changed to test 
		 $function_called = 'test functions called';
                    $user_id_log     = $userIdforfile;
					$message         = 'test function called' ;
                    $this->log_table($function_called, $user_id_log, $message);
 
 
        curl_setopt($ch, CURLOPT_URL, 'localhost/api.voice1t/v0/tv_registration');
        curl_setopt($ch, CURLOPT_POST, 1);
        $function_called = 'register voice';
        $user_id_log     = $tvid;
...
// total end with new tv	
    ...
    private function base_user_recognition()
    {
		  ...
		  $function_called = 'base_user_recognition here';
                $user_id_log     = "test";
