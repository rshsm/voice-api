		...
		*/
		...
		function log_table(&$function_called, &$user_id_log, &$message)
		{
				$query = mysql_query("INSERT INTO `voice`.`log_table` 
									...
									VALUES
									('$function_called', '$user_id_log', 'Ali Server 5', replace(replace(replace(replace(sysdate(3),'-',''),':',''),' ',''),'.','') , '$message');") or die(mysql_error());
